...
2. [Terminology](#terminoly)
   ...
   7. [Stage](#stage)
   8. [Commit](#commit-1)
   9. [Atomic commits](#atomic-commits)
   10. [log](#log)
   11. [Change default code editor](#change-default-code-editor)
...
5. [diff, stash, and Tags](#diff-stash-and-tags)
   ...
   2. [Git stash](#git-stash)
      1. [Naming the stash](#naming-the-stash)
      2. [View the stash list](#view-the-stash-list)
      3. [Apply the stash](#apply-the-stash)
      4. [Apply the specific stash](#apply-the-specific-stash)
      5. [Applying and dropping the stash](#applying-and-dropping-the-stash)
      6. [Drop the Stash](#drop-the-stash)
      7. [Applying stash to a specific branch](#applying-stash-to-a-specific-branch)
      8. [Clearing the stash](#clearing-the-stash)
   3. [Git tags](#git-tags)
      1. [Creating a tag](#creating-a-tag)
      2. [Creating an annoted tag](#create-an-annotated-tag)
      3. [List all tags](#list-all-tags)
      4. [Tagging a specific commit](#tagging-a-specific-commit)
      5. [Push tags to remote repository](#push-tags-to-remote-repository)
      6. [Delete a tag](#delete-a-tag)
6. [Rebase and reflog](#rebase-and-reflog)
   1. [Rebase in git](#rebase-in-git)
   2. [Merge commits](#merge-commits)
   3. [Rebase](#rebase)
...
7. [Getting started with Github](#getting-started-with-github)
   ...
   3. [Configure your config file](#configure-your-config-file)
   4. [Setup ssh key and add to github](#setup-ssh-key-and-add-to-github)
   5. [Adding code to remote repository](#adding-code-to-remote-repository)
   ...
   6. [Get code from remote repository](#get-code-from-remote-repository)
